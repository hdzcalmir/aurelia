...
import { $ModuleEnvRec, $GlobalEnvRec } from '../types/environment-record';
...
import { I$Node, Context, $$ESDeclaration, $$AssignmentExpressionOrHigher, $$TSDeclaration, $$ESStatementListItem, $$ModuleDeclarationParent, $$ESVarDeclaration } from './_shared';
import { $Identifier } from './expressions';
import { $ClassDeclaration } from './classes';
import { DirectivePrologue, $VariableStatement } from './statements';
