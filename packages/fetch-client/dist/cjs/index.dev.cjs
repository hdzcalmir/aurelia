...
const ICacheStorage = /*@__PURE__*/ kernel.DI.createInterface(x => x.singleton(MemoryStorage));
 ...
 */
const IFetchFn = /*@__PURE__*/ kernel.DI.createInterface('fetch', x => {
...
const ICacheService = /*@__PURE__*/ kernel.DI.createInterface(x => x.singleton(CacheService));
/**
...
class CacheService {
    constructor() {
        this.storage = kernel.resolve(ICacheStorage);
        /** @internal */ this._platform = kernel.resolve(kernel.IPlatform);
        /** @internal */ this.ea = kernel.resolve(kernel.IEventAggregator);
        /** @internal */ this._httpClient = kernel.resolve(IHttpClient);
...
class CacheInterceptor {
    constructor(config) {
        /** @internal */
        this._cacheService = kernel.resolve(ICacheService);
...
class BrowserIndexDBStorage {
    constructor() {
        this.cache = kernel.resolve(kernel.IPlatform).globalThis.indexedDB;
...
class BrowserLocalStorage extends BrowserStorage {
    constructor() {
        super(kernel.resolve(kernel.IPlatform).globalThis.localStorage);
    }
}
...
class BrowserSessionStorage extends BrowserStorage {
    constructor() {
        super(kernel.resolve(kernel.IPlatform).globalThis.sessionStorage);
    }
}
...
exports.HttpClientEvent = HttpClientEvent;
exports.ICacheService = ICacheService;
exports.ICacheStorage = ICacheStorage;
exports.IFetchFn = IFetchFn;
