...
export declare const IDevToolsExtension: import("@aurelia/kernel").InterfaceSymbol<IDevToolsExtension>;
...
export interface IDevToolsOptions {
     ...
     */
    actionCreators?: IDevtoolsActionCreator<any>[] | {
        [key: string]: IDevtoolsActionCreator<any>;
    };
    /**
...
//# sourceMappingURL=interfaces-devtools.d.ts.map