...
class Store {
    static register(c) {
        c.register(kernel.Registration.singleton(this, this), kernel.Registration.aliasTo(this, IStore));
    }
    constructor() {
        ...
        this._getDevTools = kernel.resolve(kernel.lazy(IDevToolsExtension));
    }
