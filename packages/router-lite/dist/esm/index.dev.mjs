...
import { DI, IEventAggregator, ILogger, Protocol, emptyArray, onResolve, emptyObject, resolveAll, IContainer, isArrayIndex, IModuleLoader, InstanceProvider, noop, Registration } from '@aurelia/kernel';
