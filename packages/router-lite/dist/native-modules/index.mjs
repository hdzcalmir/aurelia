...
import { DI as i, IEventAggregator as s, ILogger as n, bound as r, onResolve as o, resolveAll as h, emptyObject as a, IContainer as c, isArrayIndex as u, Protocol as l, emptyArray as f, IModuleLoader as p, InstanceProvider as d, noop as g, Registration as w } from "../kernel/dist/native-modules/index.mjs";
...
import { RecognizedRoute as O, Endpoint as j, ConfigurableRoute as D, RESIDUE as B, RouteRecognizer as M } from "../route-recognizer/dist/native-modules/index.mjs";
...
class ViewportInstructionTree {
    ...
    static create(t, e, i) {
        ...
        return null !== o ? new ViewportInstructionTree(s, false, [ o.vi ], new URLSearchParams(o.query ?? a), null) : new ViewportInstructionTree(s, false, [ ViewportInstruction.create(t) ], Nt, null);
    }
    equals(t) {
        const e = this.children;
        const i = t.children;
    ...
    static resolve(t, e, i, s) {
        ...
        return o(h, (s => {
            ...
            if (null === o) {
                const r = s.Type;
                let c = null;
                if (h) c = RouteConfig.N(t.getRouteConfig(e, i) ?? a, r, n); else c = _(t) ? zt.isConfigured(r) ? zt.getConfig(r).applyChildRouteConfig(t, n) : RouteConfig.N(t, r, n) : zt.getConfig(s.Type);
...
class ComponentAgent {
    constructor(t, e, i, s, r) {
        ...
        this.routeNode = s;
        this.ctx = r;
        this.A = r.container.get(n).scopeTo(`ComponentAgent<${r.friendlyPath}>`);
...
function ae(e, i) {
    ...
    return e.register(w.cachedCallback(ht, ((t, e, i) => {
        ...
        return r;
    })), L.hydrated(Pt, (t => t.I(i))), L.hydrated(c, RouteContext.setRoot), L.activated(Pt, (t => t.start(true))), L.deactivated(Pt, (t => {
        t.stop();
    })), ...se, ...he);
}
