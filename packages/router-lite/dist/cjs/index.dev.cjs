...
class RouteConfig {
    get path() {
        ...
        if (path.length > 0)
            return path;
        return this._path = [runtimeHtml.CustomElement.getDefinition(this.component).name];
    }
