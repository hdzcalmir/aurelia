import { DI, isArray, isFunction, isSet, isMap, areEqual, Registration, resolve, IPlatform, ILogger, isObject, isArrayIndex, createLookup, emptyObject } from '../../../kernel/dist/native-modules/index.mjs';
