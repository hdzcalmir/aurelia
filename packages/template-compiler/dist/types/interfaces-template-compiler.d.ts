...
export type StringBindingMode = 'default' | 'oneTime' | 'toView' | 'fromView' | 'twoWay';
...
export interface ITemplateCompiler {
    ...
    compile(partialDefinition: IElementComponentDefinition, context: IContainer): ICompiledElementComponentDefinition;
    /**
     ...
     */
    compileSpread<T extends IElementComponentDefinition>(requestor: T, attrSyntaxes: AttrSyntax[], container: IContainer, target: Element, 
    /**
     ...
     */
    targetDef?: T): IInstruction[];
}
export interface IDomPlatform extends IPlatform {
    document: Document;
}
//# sourceMappingURL=interfaces-template-compiler.d.ts.map