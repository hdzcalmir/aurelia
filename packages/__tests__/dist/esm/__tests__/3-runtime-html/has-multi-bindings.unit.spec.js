...
describe('3-runtime-html/has-multi-bindings.unit.spec.ts', function () {
    ...
    function hasInlineBindings(value) {
        ...
        for (let i = 0; i < len; ++i) {
            ...
            else if (ch === 36 /* Char.Dollar */ && value.charCodeAt(i + 1) === 123 /* Char.OpenBrace */) {
                return false;
            }
        }
        return false;
    ...
    function parse(value) {
        ...
        for (let i = 0; i < valueLength; ++i) {
            ...
            if (ch === 92 /* Char.Backslash */) {
                ...
                while (value.charCodeAt(++i) <= 32 /* Char.Space */)
                    ;
                start = i;
                for (; i < valueLength; ++i) {
                    ch = value.charCodeAt(i);
                ...
                while (i < valueLength && value.charCodeAt(++i) <= 32 /* Char.Space */)
                    ;
                start = i;
                attrName = void 0;
                attrValue = void 0;
