...
describe('2-runtime/binding-context.spec.ts', function () {
    ...
    describe('getContext', function () {
        it('undefined context', function () {
            assert.throws(() => Scope.getContext({ bindingContext: undefined, overrideContext: {} }, undefined, undefined), 'Scope is undefined', `() => Scope.getContext(undefined, undefined, undefined)`);
        });
        it('undefined overrides', function () {
            assert.throws(() => Scope.getContext({ bindingContext: {}, overrideContext: undefined }, undefined, undefined), 'Scope is null', `() => Scope.getContext(null, undefined, undefined)`);
        });
        it('null context', function () {
            assert.throws(() => Scope.getContext({ bindingContext: null, overrideContext: {} }, undefined, undefined), 'Scope is null', `() => Scope.getContext(null, undefined, undefined)`);
        });
        it('null overrides', function () {
            assert.throws(() => Scope.getContext({ bindingContext: {}, overrideContext: null }, undefined, undefined), 'Scope is null', `() => Scope.getContext(null, undefined, undefined)`);
        });
