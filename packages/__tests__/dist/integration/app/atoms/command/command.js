 ...
 */
let Command = (() => {
    let _classDecorators = [customElement({ name: 'command', template })];
    ...
    var Command = _classThis = class {
        constructor() {
            this.action = __runInitializers(this, _action_initializers, void 0);
            this.name = (__runInitializers(this, _action_extraInitializers), __runInitializers(this, _name_initializers, void 0));
            __runInitializers(this, _name_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "Command");
    (() => {
        ...
        Command = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Command = _classThis;
})();
export { Command };
