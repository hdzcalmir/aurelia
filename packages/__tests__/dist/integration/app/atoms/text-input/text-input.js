 ...
 */
let TextInput = (() => {
    let _classDecorators = [customElement({ name: 'text-input', template })];
    ...
    var TextInput = _classThis = class {
        constructor() {
            this.value = __runInitializers(this, _value_initializers, void 0);
            this.trigger = (__runInitializers(this, _value_extraInitializers), __runInitializers(this, _trigger_initializers, undefined));
            __runInitializers(this, _trigger_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "TextInput");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _value_decorators = [bindable];
        _trigger_decorators = [bindable];
        ...
        TextInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TextInput = _classThis;
})();
export { TextInput };
