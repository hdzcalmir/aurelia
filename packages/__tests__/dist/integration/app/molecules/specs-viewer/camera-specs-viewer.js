...
let CameraSpecsViewer = (() => {
    let _classDecorators = [customElement({ name: 'camera-specs-viewer', template })];
    ...
    var CameraSpecsViewer = _classThis = class {
        constructor() {
            this.model = __runInitializers(this, _model_initializers, void 0);
            this.focalLength = __runInitializers(this, _model_extraInitializers);
        }
        binding(..._args) {
    ...
    __setFunctionName(_classThis, "CameraSpecsViewer");
    (() => {
        ...
        CameraSpecsViewer = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CameraSpecsViewer = _classThis;
})();
