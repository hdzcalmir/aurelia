...
let LaptopSpecsViewer = (() => {
    let _classDecorators = [customElement({ name: 'laptop-specs-viewer', template })];
    ...
    var LaptopSpecsViewer = _classThis = class {
        constructor() {
            this.model = __runInitializers(this, _model_initializers, void 0);
            this.storage = __runInitializers(this, _model_extraInitializers);
        }
        binding() {
    ...
    __setFunctionName(_classThis, "LaptopSpecsViewer");
    (() => {
        ...
        LaptopSpecsViewer = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return LaptopSpecsViewer = _classThis;
})();
