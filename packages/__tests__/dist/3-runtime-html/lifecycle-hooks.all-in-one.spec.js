...
describe('3-runtime-html/lifecycle-hooks.all-in-one.spec.ts', function () {
    describe('[synchronous]', function () {
        ...
        let LoggingHook = (() => {
            ...
            let _classThis;
            var LoggingHook = _classThis = class {
                hydrating() {
                    tracker.hydrating++;
                }
                hydrated() {
            ...
            __setFunctionName(_classThis, "LoggingHook");
            (() => {
                const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
                __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
                LoggingHook = _classThis = _classDescriptor.value;
                if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
                __runInitializers(_classThis, _classExtraInitializers);
            })();
            return LoggingHook = _classThis;
        })();
    ...
    describe('[asynchronous]', function () {
        ...
        let AllLoggingHook = (() => {
            ...
            let _classExtraInitializers = [];
            let _classThis;
            var AllLoggingHook = _classThis = class {
                hydrating() {
            ...
            __setFunctionName(_classThis, "AllLoggingHook");
            (() => {
                const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
                __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
                AllLoggingHook = _classThis = _classDescriptor.value;
                if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
                __runInitializers(_classThis, _classExtraInitializers);
            })();
            return AllLoggingHook = _classThis;
        })();
