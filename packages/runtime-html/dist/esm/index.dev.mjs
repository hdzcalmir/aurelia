import { Protocol, getPrototypeChain, kebabCase, noop, DI, Registration, firstDefined, mergeArrays, IPlatform as IPlatform$1, emptyArray, InstanceProvider, fromDefinitionOrDefault, pascalCase, fromAnnotationOrTypeOrDefault, fromAnnotationOrDefinitionOrTypeOrDefault, IContainer, optional, ILogger, resolveAll, onResolve, all, camelCase, emptyObject, IServiceLocator, transient, toArray } from '@aurelia/kernel';
import { Metadata, isObject } from '@aurelia/metadata';
import { ISignaler, astEvaluate, connectable, ConnectableSwitcher, ProxyObservable, subscriberCollection, astBind, astUnbind, astAssign, IExpressionParser, IObserverLocator, ICoercionConfiguration, Scope, AccessScopeExpression, PropertyAccessor, INodeObserverLocator, getObserverLookup, SetterObserver, IDirtyChecker, createIndexMap, applyMutationsToIndices, getCollectionObserver as getCollectionObserver$1, synchronizeIndices, BindingContext, PrimitiveLiteralExpression, DirtyChecker } from '@aurelia/runtime';
