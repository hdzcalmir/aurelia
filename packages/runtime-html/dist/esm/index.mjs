...
class Rendering {
    ...
    compile(t, e) {
        ...
        if (t.needsCompile !== false) {
            if (n == null) {
                i.set(t, n = CustomElementDefinition.create(s.compile(t, e)));
            } else {
