...
class Rendering {
    ...
    get renderers() {
        return this.Dt ?? (this.Dt = this.Et.getAll(bn, false).reduce(((t, e) => {
            t[e.target] = e;
            return t;
        }), gt()));
    }
...
class Controller {
    ...
    Qt() {
        if (0 === --this.qt) {
            ...
            if (this.Vt.hasAttached) us = m(us, this.Ot.attached(this.$initiator, this.$flags));
            if (Ct(us)) {
                this.zt();
                us.then((() => {
                    this.state = 2;
    ...
    is(t) {
        switch (this.vmKind) {
          ...
          case 0:
            return on(this.Ot.constructor).name === t;
