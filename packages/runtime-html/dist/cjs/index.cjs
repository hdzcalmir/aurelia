...
class ExpressionWatcher {
    ...
    bind() {
        ...
        this.obs.version++;
        this.v = E(this.Bt, this.scope, this, this);
        this.obs.clear();
        this.isBound = true;
    }
    unbind() {
...
class Repeat {
    ...
    handleCollectionChange(t, e) {
        ...
        if (this.us) {
            ...
            this.ds = true;
            this.items = E(this.forOf.iterable, s.scope, this.ys, null);
            this.ds = false;
            return;
        }
        this.Cs();
    ...
    ks() {
        ...
        let n;
        if (i) {
            s = this.Ts = E(this.ps, t, this.ys, null) ?? null;
