...
class Rendering {
    ...
    get renderers() {
        return this.Dt ?? (this.Dt = this.Et.getAll(xi, false).reduce(((t, e) => {
            t[e.target] = e;
            return t;
        }), w()));
    }
...
class Controller {
    ...
    Qt() {
        if (0 === --this.$t) {
            ...
            if (this.Vt.hasAttached) hs = t.resolveAll(hs, this.Ot.attached(this.$initiator, this.$flags));
            if (I(hs)) {
                this.zt();
                hs.then((() => {
                    this.state = 2;
    ...
    is(t) {
        switch (this.vmKind) {
          ...
          case 0:
            return si(this.Ot.constructor).name === t;
