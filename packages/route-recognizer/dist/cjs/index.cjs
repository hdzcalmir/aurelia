...
class Candidate {
    ...
    advance(t) {
        ...
        function $process(u, a) {
            if (u.isMatch(t)) {
                if (++o === 1) {
                    r = u;
                } else {
                    n.add(new Candidate(e.concat(t), s.concat(u), a === null ? i : i.concat(a), n));
                }
            }
            if (l.segment === null && u.isOptional && u.nextStates !== null) {
              ...
              case ":":
                {
                    ...
                    u.push(new Parameter(n, o, false, h));
                    a = new DynamicSegment(n, o, h).appendTo(a);
                    break;
                }
              ...
              case "*":
                {
                    ...
                    u.push(new Parameter(e, true, true, null));
                    a = new StarSegment(e, n).appendTo(a);
                    break;
                }

              default:
                {
                    a = new StaticSegment(s, o.caseSensitive).appendTo(a);
                    break;
                }
            }
        }
        const h = new Endpoint(o, u);
        a.setEndpoint(h);
        r.set(n, h);
        return h;
    }
