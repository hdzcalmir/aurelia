    ...
    toType(t, e) {
        ...
        if (this.name !== null && typeof this.name === "string") {
            ...
            if (t.has(i.CustomElement.keyFrom(this.name), true)) {
                const e = t.getResolver(i.CustomElement.keyFrom(this.name));
                if (e !== null && e.getFactory !== void 0) {
                    const i = e.getFactory(t);
                    if (i) {
                        return i.Type;
                    }
                }
...
class Route {
    ...
    static isConfigured(t) {
        return e.Metadata.hasOwn(Route.resourceKey, t) || "parameters" in t || "title" in t;
    }
    static configure(t, i) {
        const s = Route.create(t, i);
        e.Metadata.define(Route.resourceKey, s, i);
        return i;
    }
    static getConfiguration(t) {
        const i = e.Metadata.getOwn(Route.resourceKey, t) ?? {};
    ...
    static create(t, e = null) {
        if (e !== null) {
            t = Route.transferTypeToComponent(t, e);
        }
    ...
    static transferTypeToComponent(t, e) {
        if (i.CustomElement.isType(t)) {
        ...
        if (!("path" in s) && !("redirectTo" in s)) {
            s.path = i.CustomElement.getDefinition(e).name;
        }
        return s;
    }
...
const n = {
    ...
    isConfigured(t) {
        return e.Metadata.hasOwn(n.name, t) || "routes" in t;
    },
    configure(t, i) {
        const s = t.map((t => Route.create(t)));
        e.Metadata.define(n.name, s, i);
        return i;
    },
    getConfiguration(t) {
        const i = t;
        const s = [];
        const r = e.Metadata.getOwn(n.name, t);
        if (Array.isArray(r)) {
            s.push(...r);
        }
...
class Viewport extends Endpoint$1 {
    ...
    getComponentType() {
        ...
        if (t === null) {
            const e = i.CustomElement.for(this.connectedCE.element);
            t = e.container.componentType;
        }
        return t ?? null;
    }
...
exports.Navigator = __decorate([ __param(0, t.IEventAggregator), __param(1, t.IContainer) ], exports.Navigator);

const r = s.RouteRecognizer;

const o = s.ConfigurableRoute;

const h = s.RecognizedRoute;
...
class RoutingScope {
    ...
    static for(t, e) {
        ...
        let r = n?.scope ?? null;
        if (r === null || e === undefined) {
            const t = e ?? "";
            return {
                scope: r,
                instruction: t.startsWith("/") ? t.slice(1) : e
            };
        }
        if (e.startsWith("/")) {
            return {
                scope: null,
                instruction: e.slice(1)
            };
        }
        while (e.startsWith(".")) {
            if (e.startsWith("./")) {
    ...
    findMatchingRouteInRoutes(t, i, e) {
        ...
        if (o != null) {
            ...
            t = Array.isArray(o.path) ? o.path[0] : o.path;
        ...
        if (h != null) {
            s.match = h.endpoint.route.handler;
            s.matching = t;
            const n = {
                ...h.params
            };
...
let a = class BrowserViewerStore {
...
a = __decorate([ __param(0, i.IPlatform), __param(1, i.IWindow), __param(2, i.IHistory), __param(3, i.ILocation), __param(4, t.IEventAggregator) ], a);
...
const l = /*@__PURE__*/ t.DI.createInterface("IRouter", (t => t.singleton(Router)));

class Router {
    static get inject() {
        return [ t.IContainer, t.IEventAggregator, exports.Navigator, a, a, d ];
    }
    constructor(t, i, e, s, n, r) {
        this.container = t;
        this.ea = i;
    ...
    start() {
        ...
        if (e.basePath === null) {
            ...
            e.basePath = i.pathname;
        }
        if (e.basePath.endsWith("/")) {
            e.basePath = e.basePath.slice(0, -1);
        }
...
const c = /*@__PURE__*/ t.DI.createInterface("ILinkHandler", (t => t.singleton(exports.LinkHandler)));
...
exports.LinkHandler = class LinkHandler {
    ...
    handleClick(t) {
        ...
        const n = i.CustomAttribute.for(e, "load");
        const r = n !== void 0 ? n.viewModel.value : null;
        const o = this.router.configuration.options.useHref && e.hasAttribute("href") ? e.getAttribute("href") : null;
...
exports.LinkHandler = __decorate([ __param(0, i.IWindow), __param(1, l) ], exports.LinkHandler);
...
function getConsideredActiveInstructions(t, e, s, n) {
    let r = i.CustomAttribute.for(s, "considered-active")?.viewModel?.value;
    if (r === void 0) {
        r = n;
    }
...
const f = i.CustomElement.createInjectable();
...
__decorate([ i.bindable ], exports.ViewportCustomElement.prototype, "name", void 0);

__decorate([ i.bindable ], exports.ViewportCustomElement.prototype, "usedBy", void 0);

__decorate([ i.bindable ], exports.ViewportCustomElement.prototype, "default", void 0);

__decorate([ i.bindable ], exports.ViewportCustomElement.prototype, "fallback", void 0);

__decorate([ i.bindable ], exports.ViewportCustomElement.prototype, "fallbackAction", void 0);

__decorate([ i.bindable ], exports.ViewportCustomElement.prototype, "noScope", void 0);

__decorate([ i.bindable ], exports.ViewportCustomElement.prototype, "noLink", void 0);

__decorate([ i.bindable ], exports.ViewportCustomElement.prototype, "noTitle", void 0);

__decorate([ i.bindable ], exports.ViewportCustomElement.prototype, "noHistory", void 0);

__decorate([ i.bindable ], exports.ViewportCustomElement.prototype, "stateful", void 0);

exports.ViewportCustomElement = __decorate([ i.customElement({
    name: "au-viewport",
    injectable: f
}), __param(0, l), __param(1, i.INode), __param(2, t.IContainer), __param(3, t.IEventAggregator), __param(4, f), __param(5, i.IInstruction) ], exports.ViewportCustomElement);
...
__decorate([ i.bindable ], exports.ViewportScopeCustomElement.prototype, "name", void 0);

__decorate([ i.bindable ], exports.ViewportScopeCustomElement.prototype, "catches", void 0);

__decorate([ i.bindable ], exports.ViewportScopeCustomElement.prototype, "collection", void 0);

__decorate([ i.bindable ], exports.ViewportScopeCustomElement.prototype, "source", void 0);

exports.ViewportScopeCustomElement = __decorate([ i.customElement({
    name: "au-viewport-scope",
    template: "<template></template>",
    containerless: false,
    injectable: p
}), __param(0, l), __param(1, i.INode), __param(2, t.IContainer), __param(3, p), __param(4, i.IController) ], exports.ViewportScopeCustomElement);
...
exports.LoadCustomAttribute = class LoadCustomAttribute {
    ...
    async updateActive() {
        ...
        const e = typeof this.value === "string" ? {
            id: this.value,
            path: this.value
        } : this.value;
        const s = this.u(e);
...
__decorate([ i.bindable ], exports.LoadCustomAttribute.prototype, "parameters", void 0);

__decorate([ i.bindable ], exports.LoadCustomAttribute.prototype, "viewport", void 0);

__decorate([ i.bindable ], exports.LoadCustomAttribute.prototype, "id", void 0);

exports.LoadCustomAttribute = __decorate([ i.customAttribute("load"), __param(0, i.INode), __param(1, l), __param(2, c), __param(3, t.IEventAggregator) ], exports.LoadCustomAttribute);
...
exports.HrefCustomAttribute = class HrefCustomAttribute {
    ...
    updateActive() {
        if (this.router.configuration.options.useHref && !this.hasLoad() && !this.element.hasAttribute("external")) {
            ...
            const e = getConsideredActiveInstructions(this.router, t, this.element, this.value);
            const s = getLoadIndicator(this.element);
            s.classList.toggle(this.activeClass, this.router.checkActive(e, {
                context: t
            }));
        }
    }
...
}), __param(0, i.INode), __param(1, l), __param(2, c), __param(3, t.IEventAggregator) ], exports.HrefCustomAttribute);
...
const d = /*@__PURE__*/ t.DI.createInterface("IRouterConfiguration", (t => t.singleton(RouterConfiguration)));

const g = l;

const v = [ g ];

const m = exports.ViewportCustomElement;

const w = exports.ViewportScopeCustomElement;

const R = exports.LoadCustomAttribute;

const y = exports.HrefCustomAttribute;

const I = [ exports.ViewportCustomElement, exports.ViewportScopeCustomElement, exports.LoadCustomAttribute, exports.HrefCustomAttribute, exports.ConsideredActiveCustomAttribute ];
...
class RouterConfiguration {
    static register(t) {
        ...
        return t.register(...v, ...I, i.AppTask.activating(l, RouterConfiguration.configurationCall), i.AppTask.activated(l, (t => t.initialLoad())), i.AppTask.deactivated(l, (t => t.stop())));
    }
    static customize(t) {
        if (t === undefined) {
            RouterConfiguration.options = RouterOptions.create();
...
exports.ConfigurableRoute = o;

exports.DefaultComponents = v;
...
exports.HrefCustomAttributeRegistration = y;

exports.ILinkHandler = c;

exports.IRouter = l;

exports.IRouterConfiguration = d;

exports.InstructionParameters = InstructionParameters;

exports.LoadCustomAttributeRegistration = R;
...
exports.RecognizedRoute = h;

exports.RecognizerEndpoint = u;

exports.Route = Route;

exports.RouteRecognizer = r;
...
exports.ViewportCustomElementRegistration = m;
...
exports.ViewportScopeCustomElementRegistration = w;
