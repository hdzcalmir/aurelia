...
import { StandardConfiguration as y, IPlatform as x, ITemplateCompiler as $, CustomElement as w, InstructionType as E, CustomAttribute as k, Aurelia as S, valueConverter as C, bindable as O, customElement as j } from "../../../runtime-html/dist/native-modules/index.mjs";
...
const J = T(Uint8Array.prototype);

const K = uncurryThis(F(J, Symbol.toStringTag).get);
...
function formatIterator(e, t, n, i) {
    ...
    return formatSetIterInner(e, n, r, Re);
}
